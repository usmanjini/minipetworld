                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($posts as $key => $post)
                                    ...
                                    <tr id="{{$post->id}}"> 
                                        ...
                                        @endif
                                         <td>
                                        <a href="{{ url('/post_edit/' . $post->id ) }}" class="btn btn-outline-info">Edit</a> 
                                        <a href="{{ url('/del_post/' . $post->id ) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                        </td>
                                    </tr> 
                                @endforeach
