                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Complete all input fields for adding New subcategory.</p>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{route('categories')}}">Categories View</a></li>
  ...
  <div class="form-group field_wrapper">
    <div class="row">
      ...
      <div class="col-md-12" style="padding-top: 20px;">
       ...
       <div>
          <textarea class="form-control" type="text"  id="descriptions"  name="descriptions" placeholder="Enter SubCategory Discription" placeholder="Enter Product Discription" required rows="3"></textarea>
       </div>
      </div>
