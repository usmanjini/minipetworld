                              ...
                              <table class="table table-striped" id="table1">
                                  ...
                                  @foreach($centers as $key => $center)
                                      ...
                                      <tr id="{{$center->id}}"> 
                                          ...
                                          <td> 
                                          <a href="{{ route('relocation_edit' ,$center->id) }}" class="btn btn-outline-info">Edit</a> 
                                          <a href="{{ route('del_relocation' ,$center->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                          </td>
                                      </tr> 
                                  @endforeach
