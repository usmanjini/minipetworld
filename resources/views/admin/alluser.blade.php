                  ...
                  <div class="page-title">
                      <div class="row">
                          <div class="col-12 col-md-6 order-md-1 order-last">
                              <h3>User View</h3>
                              <p class="text-subtitle text-muted">For all User views and delete.</p>
                          </div>
                      ...
                      <div class="card"> 
                        <div class="card-body">
                              <table class="table table-striped" id="table1">
                                  ...
                                  @php $users = \App\user::where('role_id',2)->get(); @endphp
                                  @foreach($users as $key => $user)
                                      ...
                                      <tr id="{{$user->id}}"> 
                                          ...
                                          <td>{{ $user->email}}</td> 
                                          <td> 
                                          <a href="{{ route('del_user' ,$user->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                          </td>
                                      </tr> 
                                  @endforeach
