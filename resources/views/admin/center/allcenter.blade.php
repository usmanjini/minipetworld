                  ...
                  <div class="page-title">
                      <div class="row">
                          <div class="col-12 col-md-6 order-md-1 order-last">
                              <h3>Center View</h3>
                              <p class="text-subtitle text-muted">For images and text view in Center.</p>
                          </div>
                          <div class="col-12 col-md-6 order-md-2 order-first">
                              <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                  <ol class="breadcrumb">
                                      <li class="breadcrumb-item"><a href="{{route('admin.login')}}">Dashboard</a></li>
                                      <li class="breadcrumb-item active" aria-current="page">Centers View</li>
                                  </ol>
                              </nav>
                          </div>
                      </div>
                              ...
                              <table class="table table-striped" id="table1">
                                  ...
                                  @foreach($centers as $key => $center)
                                      ...
                                      <tr id="{{$center->id}}"> 
                                          ...
                                          <td><img src="{{ asset('images/' . $center->image) }}"  class="img-resposive"  width="100px" height="50px" ></td> 
                                          <td> 
                                          <a href="{{ route('centers_edit' ,$center->id) }}" class="btn btn-outline-info">Edit</a> 
                                          <a href="{{ route('del_center' ,$center->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                          </td>
                                      </tr> 
                                  @endforeach
