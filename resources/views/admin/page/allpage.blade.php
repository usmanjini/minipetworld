                  ...
                  <div class="page-title">
                      <div class="row">
                          <div class="col-12 col-md-6 order-md-1 order-last">
                              <h3>Pages View</h3>
                              <p class="text-subtitle text-muted">For images and text view of Pages.</p>
                          </div>
                              ...
                              <table class="table table-striped" id="table1">
                                  ...
                                  @foreach($page as $key => $cat)
                                      ...
                                      <tr id="{{$cat->id}}"> 
                                          ...
                                          <td>{{ $cat->name}}</td>
                                          <td> <img src="{{ asset('images/page/' . $cat->image)}}"  class="img-resposive"  width="100px" height="50px" ></td>
                                          <td>{{ $cat->description}}</td>
                                          <td>
                                          <a href="{{ route('page_edit' ,$cat->id) }}" class="btn btn-outline-info">Edit</a> 
                                          <a href="{{ route('del_page' ,$cat->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                          </td>
                                      </tr> 
                                  @endforeach
