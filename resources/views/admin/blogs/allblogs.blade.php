                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Blogs View</h3>
                            <p class="text-subtitle text-muted">For images and text view in Blogs.</p>
                        </div>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($blogs as $key => $blog)
                                    ...
                                    <tr id="{{$blog->id}}"> 
                                        ...
                                        <td>{{ $blog->title}}</td> 
                                        <td><img src="{{ asset('images/blogs/' . $blog->image)}}"  class="img-resposive"  width="100px" height="50px" ></td> 
                                        <td> 
                                        <a href="{{ route('blog_edit' ,$blog->id) }}" class="btn btn-outline-info">Edit</a> 
                                        <a href="{{ route('del_blog' ,$blog->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                        </td>
                                    </tr> 
                                @endforeach
