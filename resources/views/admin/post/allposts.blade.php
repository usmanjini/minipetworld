                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($posts as $key => $post)
                                    ...
                                    <tr id="{{$post->id}}"> 
                                        ...
                                        @endif
                                        <td>  
                                        <a href="{{ route('accept_post' ,$post->id) }}" class="btn btn-outline-success">Accept</a> 
                                        <a href="{{ route('reject_post' ,$post->id) }}"onclick="return confirm('Are you sure you want to Reject this Request?');"  class="btn btn-outline-danger">Reject</a>
                                        </td>
                                    </tr> 
                                @endforeach
