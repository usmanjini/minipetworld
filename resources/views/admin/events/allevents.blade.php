                  ...
                  <div class="page-title">
                      <div class="row">
                          <div class="col-12 col-md-6 order-md-1 order-last">
                              <h3>Event View</h3>
                              <p class="text-subtitle text-muted">For images and text view in Event.</p>
                          </div>
                              ...
                              <table class="table table-striped" id="table1">
                                  ...
                                  @foreach($events as $key => $event)
                                      ...
                                      <tr id="{{$event->id}}"> 
                                          ...
                                          <td><img src="{{ asset('images/' . $event->image) }}"  class="img-resposive"  width="100px" height="50px" ></td> 
                                          <td> 
                                          <a href="{{ route('events_edit' ,$event->id) }}" class="btn btn-outline-info">Edit</a> 
                                          <a href="{{ route('del_event' ,$event->id) }}"onclick="return confirm('Are you sure you want to delete this item?');"  class="btn btn-outline-danger">Delete</a>
                                          </td>
                                      </tr> 
                                  @endforeach
